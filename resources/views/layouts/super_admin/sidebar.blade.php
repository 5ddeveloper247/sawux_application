                ...
                <div class="dashboard">
                    <li class="nav-item ">
                        <a href="{{ route($menu->link) }}" 
                            class=" d-flex gap-1 align-items-center justify-content-start text-start nav-link sidebar-sub-links-bg rounded-2 px-5 {{request()->routeIs($menu->link) ? 'active' : 'sdf'}}">
