{{-- <footer>
    <div class="main-footer toggle-button ">
        <div class="d-flex align-items-center p-md-3 p-2 justify-content-center" style="font-size:12px;">
            <p class="mb-0">Thank you for creating with S A W U X | 2024 ©</p>&nbsp;&nbsp;
             <a class="mx-1" href="javascript:;">s a W u x</a>
            <img src="{{asset('assets/images/logo-new.png')}}" alt="phoenix" width="35">
        </div>
    </div>
</footer> --}}
