        ...
        $(document).ready(function() {
            ...
            function pageLoader() {
                ...
                var table = $('#exam-listing').DataTable({
                    ...
                    "bDestroy": true,
                    ajax: {
                        url: "{{ route('superadmin.customer.users.listAll') }}", // URL to your route
            ...
            $(".save-data").click(function() {
                ...
                let type = 'POST';
                let url = '/admin/customer-users/creat';
            ...
            $("#exam-listing").on('click', '.edit-btn', function(e) {
                ...
                $("#id").val(id);
                let type = 'POST';
                let url = '/admin/customer-users/edit';
            ...
            $("#exam-listing").on('click', '.delete-btn', function(e) {
                ...
                let type = 'POST';
                let url = '/admin/customer-users/delete';
                let data = new FormData();
                data.append('id', id);
